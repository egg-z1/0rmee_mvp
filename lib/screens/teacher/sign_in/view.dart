        ...
        child: SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  enabledBorder: OutlineInputBorder(
                    ...
                    borderSide:
                        BorderSide(width: 1, color: OrmeeColor.grey[20]!),
                  ),
                  focusedBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(10),
                    borderSide:
                        BorderSide(width: 1, color: OrmeeColor.purple[40]!),
                  ),
                  hintText: '아이디',
                  hintStyle: TextStyle(
              ...
              GestureDetector(
                onTap: () async {
                  if (await controller.checkTeacherInfo(Teacher(
                          code: int.parse(controller.codeController.text),
